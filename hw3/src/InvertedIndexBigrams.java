...
public class InvertedIndexBigrams {
	...
	public static class Bigrams_Mapper extends Mapper<Object, Text, Text, Text> {
		/*
		...
		// Key - not use in bigrams
		// Value - <word1 word2, doc id>
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			 ...
			 * Clean text:
			 * 1. Lower case
			 * 2. Turn all special chars and numerals to white space
			...
			while (tokenizer.hasMoreTokens()) {
				...
				now = tokenizer.nextToken();
				word.set(previous + " " + now);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setMapperClass(Bigrams_Mapper.class);
